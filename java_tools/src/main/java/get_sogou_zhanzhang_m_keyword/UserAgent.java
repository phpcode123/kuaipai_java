	...
	public static String randPcUserAgentString(int num) {
		...
		switch(num) {
			case 1:
				...
				userAgent = "Mozilla/5.0 (Windows NT "+sysVersion.get(OtherClass.getRandomBetweenNumbers(0, sysVersion.size()))+"; Win64; x64) AppleWebKit/"+versionNum2+" (KHTML, like Gecko) Chrome/"+versionNum1+" Safari/"+versionNum2;
				break;
			case 2:
