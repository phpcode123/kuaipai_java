...
public class OtherClass {
	...
	public static String getAizhanUrl() {
		if(Settings.isPc) {
			return OtherClass.stringReplaceAll("\\[domainName\\]", Settings.domainName, Settings.aizhanPcPageUrl);
		}else {
			return OtherClass.stringReplaceAll("\\[domainName\\]", Settings.domainName, Settings.aizhanMPageUrl);
		}
	}
