...
//		
		...
		while(m.find()) {
			//countNum += 1; 
			if(!m.group(1).contains("拦截") && !m.group(1).contains("被墙")) {
				String pat1 = "<td><spanclass=\"id\">.*?</span></td><td><p>(.*?)</p></td><tdclass=\"qqjc\"><spanstyle=\"color:black\">(.*?)<astyle=\"color:skyblue;margin-left:10px\".*?</span></td><tdclass=\"weixin\"><spanstyle=\"color:black\">(.*?)</span></td><tdclass=\"qiang\"><spanstyle=\"color:black\">(.*?)</span></td></tr>";
