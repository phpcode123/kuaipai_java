...
public class Settings {
	...
	//程序主要名称
	public static String mainName = "baidu_pc_sifu";
    ...
    //关键词在搜索引擎中最大的失败次数，当页面搜索到第Settings.maxBaiduPageNum 页时还没有找到此关键词结果，就将此关键词的计数+1，如果总数超过此次值则跳过此关键词，可提高效率
    public static final int MAX_SEARCH_TIMES = 50000;
