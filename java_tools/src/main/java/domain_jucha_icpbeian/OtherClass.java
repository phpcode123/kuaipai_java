...
public class OtherClass {
	...
	public static String cleanLine(String pattern, String str) {
		String line = str.replaceAll(pattern, "");
		return line;
	}
...
//		return  rscDid;
	...
	public static Matcher regexReturnMatcher(String fileContent,  String pat) {
