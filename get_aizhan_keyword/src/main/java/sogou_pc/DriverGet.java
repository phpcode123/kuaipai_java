...
public class DriverGet extends ChromeOptions {
	...
	public static WebDriver get(String url,String proxyString) {
		...
		String userAgent = RandUserAgent.randPcUserAgent();
	    ...
	    driver.manage().timeouts().setScriptTimeout(Duration.ofSeconds(15));//脚本执行超时
	    driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(15));//页面加载超时
