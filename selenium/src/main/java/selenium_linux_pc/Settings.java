...
//	public static String proxyPass = "308equk0";
	...
	public static String webglCrxFilePath = "/Backups/java/extends/webgl-fingerprint-defende.crx";
	public static String audioContentCrxFilePath = "/Backups/java/extends/audiocontext-fingerprint.crx";
	public static String fontCrxFilePath = "/Backups/java/extends/font-fingerprint-defender.crx";
	public static String canvasCrxFilePath = "/Backups/java/extends/canvas-fingerprint-defend.crx";
