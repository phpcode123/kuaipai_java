...
public class Main_baidu_pc_zhannei_search {
			...
			try {
				...
				for(String searchKeyword : keywordList) {
					...
					try {
						...
						WebDriver driver =  DriverGet.get("https://bot.sannysoft.com/",proxyIpString);
						...
						try {
							...
							OtherClass.timeSleep(1);
							driver.findElement(By.className("search_tool_si")).click();
							OtherClass.timeSleep(1);
							driver.findElement(By.className("c-tip-si-input")).sendKeys("panfa.net");
							OtherClass.timeSleep(1);
							driver.findElement(By.className("c-tip-timerfilter-si-submit")).click();
							OtherClass.timeSleep(1);
							...
							for(String domain_ :Settings.domainList()) {
								System.out.println("domain_:"+domain_);
	...
	//								String xpathStr = "";
	//								if(countNum == 1) {
	//									xpathStr = "//div[@id=\""+String.valueOf(baiduPageNum*10-10+countNum)+"\"]";
	...
	//								
									...
									//xpathStr
									String xpathStr = "//div[@tpl=\"se_com_default\"]";
									System.out.println(">> xpathStr:" + xpathStr);
									
									System.out.println(">> linkur:"+driver.getCurrentUrl());
									try {
										...
										try {
											...
											if(matchSearchWebsite.size() > 0) {
												...
												try {
													int clickSuccessNum = 0;
													
													try {
														//xpath
														String clickXpath = "//div[@tpl=\"se_com_default\"]/div/h3/a";
														...
														//页面在不断的变化，如果上面的xptah不行就使用下面的xpath
														String clickXpath = "//div[@tpl=\"se_com_default\"]/h3/a";
