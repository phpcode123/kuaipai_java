...
public class DriverGet extends ChromeOptions {
	...
	public static WebDriver get(String url,String proxyString) {
		...
		String gpuRendererParam = "ANGLE (Intel, Intel(R) UHD Graphics 630 Direct3D11 vs_5_0 ps_5_0, D3D11-"+String.valueOf(OtherClass.getRandomBetweenNumbers(1, 99))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(1, 99))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(1, 999))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(100, 9999))+")";
		...
		options.addArguments("--languages-param=zh-CN,zh;q=0.9");
		...
		if(OtherClass.isLinux()) {
			options.setBinary("/code/chromium/src/out/Default/chrome");
		}
