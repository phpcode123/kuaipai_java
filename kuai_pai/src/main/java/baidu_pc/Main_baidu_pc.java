									...
									try {
										...
										try {
											...
											if(countNum > blockNum) {
												String newXpath = "//div[@id=\""+String.valueOf(baiduPageNum*10-10+countNum)+"\"]";
											...
											if(matchSearchWebsite.size() > 0) {
												...
												try {
													try {
														//xpath
														String clickXpath = "//div[@id=\""+String.valueOf(baiduPageNum*10-10+countNum)+"\"]/div/h3/a";
														...
														//xpath
														String clickXpath = "//div[@id=\""+String.valueOf(baiduPageNum*10-10+countNum)+"\"]/h3/a";
