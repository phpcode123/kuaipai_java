...
public class UserAgent {
	...
	public static String randPcUserAgentString(int num) {
		String userAgent;
		String versionNum1;
		String versionNum2;
		String versionNum3;
		...
		switch(num) {
			case 1:
				versionNum1 = String.valueOf(OtherClass.getRandomBetweenNumbers(86, 93))+".0."+String.valueOf(OtherClass.getRandomBetweenNumbers(1000, 5000))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(10,999));
				versionNum2 = String.valueOf(OtherClass.getRandomBetweenNumbers(100, 537))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(10, 99));
				ArrayList<String> sysVersion = new ArrayList<String>();
				sysVersion.add("7.0");
				sysVersion.add("7.1");
				sysVersion.add("8.1");
				sysVersion.add("10.0");
				
				userAgent = "Mozilla/5.0 (Windows NT "+sysVersion.get(OtherClass.getRandomBetweenNumbers(0, sysVersion.size()-1))+"; Win64; x64) AppleWebKit/"+versionNum2+" (KHTML, like Gecko) Chrome/"+versionNum1+" Safari/"+versionNum2;
				break;
			case 2:
				versionNum1 = String.valueOf(OtherClass.getRandomBetweenNumbers(6, 11))+"_"+String.valueOf(OtherClass.getRandomBetweenNumbers(1, 10))+"_"+String.valueOf(OtherClass.getRandomBetweenNumbers(1, 99));
				versionNum2 = String.valueOf(OtherClass.getRandomBetweenNumbers(100, 999))+"_"+String.valueOf(OtherClass.getRandomBetweenNumbers(10, 99));
				versionNum3 = String.valueOf(OtherClass.getRandomBetweenNumbers(1, 9))+"_"+String.valueOf(OtherClass.getRandomBetweenNumbers(1, 9))+"_"+String.valueOf(OtherClass.getRandomBetweenNumbers(1, 9));
				userAgent = "Mozilla/5.0 (Macintosh; U; Intel Mac OS X "+versionNum1+"; zh-CN) AppleWebKit/"+versionNum2+" (KHTML, like Gecko) Version/"+versionNum3+" Safari/"+versionNum2;
				
				break;
				
			case 3:
				versionNum1 = String.valueOf(OtherClass.getRandomBetweenNumbers(8, 10))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(8, 99));
				versionNum2 = String.valueOf(OtherClass.getRandomBetweenNumbers(1, 9))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(0, 99));
				userAgent = "Mozilla/5.0 (compatible; MSIE "+versionNum1+"; Windows NT 7.1; Trident/"+versionNum2+")";
				break;
			default:
				versionNum1 = String.valueOf(OtherClass.getRandomBetweenNumbers(6, 11))+"_"+String.valueOf(OtherClass.getRandomBetweenNumbers(1, 10))+"_"+String.valueOf(OtherClass.getRandomBetweenNumbers(1, 99));
				versionNum2 = String.valueOf(OtherClass.getRandomBetweenNumbers(100, 999))+"_"+String.valueOf(OtherClass.getRandomBetweenNumbers(10, 99));
...
//	public static String randMUserAgentString(int num) {
//		ArrayList<String> mobileVersion;
//		String userAgent;
//		String versionNum1;
//		String versionNum2;
//		String versionNum3;
...
//		
//
//		versionNum1 = String.valueOf(OtherClass.getRandomBetweenNumbers(5, 12))+".0."+String.valueOf(OtherClass.getRandomBetweenNumbers(0, 10));
//		versionNum2 = String.valueOf(OtherClass.getRandomBetweenNumbers(1, 9))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(100000, 999999))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(100, 999));
//		versionNum3 = String.valueOf(OtherClass.getRandomBetweenNumbers(100, 999))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(10, 99));
//		versionNum4 = String.valueOf(OtherClass.getRandomBetweenNumbers(10, 99))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(0, 9))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(10,99));
//		versionNum5 = String.valueOf(OtherClass.getRandomBetweenNumbers(65, 89))+".0."+String.valueOf(OtherClass.getRandomBetweenNumbers(1000, 5000))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(10,999));
//		mobileVersion = new ArrayList<String>();
//		mobileVersion.add("ANE-AL00");
//		mobileVersion.add("AQM-AL10");
//		mobileVersion.add("ART-AL00x");
//		mobileVersion.add("BKK-AL10");
//		mobileVersion.add("BLA-AL00");
//		mobileVersion.add("BND-AL10");
//		mobileVersion.add("CDY-AN20");
//		mobileVersion.add("CPN-W09");
//		mobileVersion.add("DVC-AN20");
//		mobileVersion.add("ELE-AL00");
//		mobileVersion.add("FRD-AL00");
//		mobileVersion.add("JKM-AL00");
//		mobileVersion.add("JKM-AL00b");
//		mobileVersion.add("PCT-AL10");
//		mobileVersion.add("PRA-AL00X");
//		mobileVersion.add("LG-H870DS");
//		mobileVersion.add("MI MAX");
//		mobileVersion.add("OPPO A37t");
//		mobileVersion.add("OPPO A73");
//		mobileVersion.add("OPPO R11s");
//		mobileVersion.add("OPPO R11t");
//		mobileVersion.add("OPPO R9s");
//		mobileVersion.add("OXF-AN00");
//		mobileVersion.add("PADM00");
//		mobileVersion.add("Redmi 3");
//		mobileVersion.add("Redmi K30 5G");
//		mobileVersion.add("SM-C9000");
//		mobileVersion.add("TAS-AN00");
//		mobileVersion.add("V1731CA");
//		mobileVersion.add("V1732A");
//		mobileVersion.add("V1818CT");
//		mobileVersion.add("vivo V3Max A");
//		mobileVersion.add("vivo V3Max");
//		mobileVersion.add("vivo X9");
//		mobileVersion.add("vivo X9Plus");
//		mobileVersion.add("vivo X9 Plus");
//		mobileVersion.add("vivo X9s");
//		mobileVersion.add("vivo Xplay6");
//		mobileVersion.add("vivo Y31");
//		mobileVersion.add("vivo Y51");
//		mobileVersion.add("vivo Y51A");
//		mobileVersion.add("vivo Y51t");
//		mobileVersion.add("vivo Y55t");
//		mobileVersion.add("vivo Y67L");
//		mobileVersion.add("vivo Y71A");
//		mobileVersion.add("vivo Y75s");
//		mobileVersion.add("vivo X21A");
//		mobileVersion.add("Redmi 6");
//		mobileVersion.add("OPPO R11st");
//		mobileVersion.add("Mi Note 3");
//		mobileVersion.add("Mi Note 2");
//		mobileVersion.add("MIX 2S");
//		mobileVersion.add("MIX 3S");
//
//		int randNum = OtherClass.getRandomBetweenNumbers(1, 5);
//		switch(randNum) {
//			case 1:
//				userAgent = "Mozilla/5.0 (Linux; U; Android "+versionNum1+" zh-CN; "+mobileVersion.get(OtherClass.randomNum(mobileVersion.size()))+" Pro Build/PPR"+versionNum2+") AppleWebKit/"+versionNum3+" (KHTML, like Gecko) Version/4.0 Chrome/"+versionNum5+" Mobile Safari/"+versionNum3+" Browser/"+versionNum4;
//				break;
//			case 2:
//				userAgent = "Mozilla/5.0 (Linux; U; Android "+versionNum1+" zh-CN; "+mobileVersion.get(OtherClass.randomNum(mobileVersion.size()))+" Pro Build/PPR"+versionNum2+") AppleWebKit/"+versionNum3+" (KHTML, like Gecko) Version/4.0 Chrome/"+versionNum5+" MQQBrowser Safari/"+versionNum3+" COVC/"+versionNum4;
//				break;
//				
//			case 3:
//				userAgent = "Mozilla/5.0 (Linux; U; Android "+versionNum1+" zh-CN; Pro Build/PPR"+versionNum2+") AppleWebKit/"+versionNum3+" (KHTML, like Gecko) Version/4.0 Chrome/"+versionNum5+" HuaweiBrowser/"+versionNum4+" Mobile Safari/"+versionNum3;
//				break;
//			case 4:
//				userAgent = "Mozilla/5.0 (Linux; U; Android "+versionNum1+" zh-CN; "+mobileVersion.get(OtherClass.randomNum(mobileVersion.size()))+" Pro Build/PPR"+versionNum2+") AppleWebKit/"+versionNum3+" (KHTML, like Gecko) RV:"+versionNum4+" Mobile/"+versionNum5+" Firefox/"+versionNum3;
//				break;
//				
//			case 5:
//				userAgent = "Mozilla/5.0 (Linux; U; Android "+versionNum1+" zh-CN; Pro Build/PPR"+versionNum2+") AppleWebKit/"+versionNum3+" (KHTML, like Gecko) Version/4.0 Chrome/"+versionNum5+" XiaoMi/MiuiBrowser/"+versionNum4+" Mobile Safari/"+versionNum3;
//				break;
//			default:
//				
//				userAgent = "Mozilla/5.0 (Linux; U; Android "+versionNum1+" zh-CN; "+mobileVersion.get(OtherClass.randomNum(mobileVersion.size()))+" Pro Build/PPR"+versionNum2+") AppleWebKit/"+versionNum3+" (KHTML, like Gecko) Version/4.0 Chrome/"+versionNum5+" Mobile Safari/"+versionNum3+" Browser/"+versionNum4;
...
//
//
////				versionNum1 = String.valueOf(OtherClass.getRandomBetweenNumbers(6, 12))+"_"+String.valueOf(OtherClass.getRandomBetweenNumbers(0, 10));
////				versionNum2 = String.valueOf(OtherClass.getRandomBetweenNumbers(100, 999))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(0, 9))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(0, 99));
////				versionNum3 = String.valueOf(OtherClass.getRandomBetweenNumbers(0, 9))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(0, 9))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(0, 2));
////				versionNum4 = String.valueOf(OtherClass.getRandomBetweenNumbers(10, 99))+"A"+String.valueOf(OtherClass.getRandomBetweenNumbers(100, 999));
////				versionNum5 = String.valueOf(OtherClass.getRandomBetweenNumbers(1000, 9999))+"."+String.valueOf(OtherClass.getRandomBetweenNumbers(10, 999));
////				mobileVersion = new ArrayList<String>();
////				mobileVersion.add("6");
////				mobileVersion.add("6s");
////				mobileVersion.add("6sp");
////				mobileVersion.add("7");
////				mobileVersion.add("7s");
////				mobileVersion.add("7sp");
////				mobileVersion.add("8");
////				mobileVersion.add("8s");
////				mobileVersion.add("8sp");
////				mobileVersion.add("9");
////				mobileVersion.add("9s");
////				mobileVersion.add("9sp");
////				mobileVersion.add("X");
////				mobileVersion.add("Xs");
////				mobileVersion.add("Xsp");
////				mobileVersion.add("11");
////				mobileVersion.add("11s");
////				mobileVersion.add("11sp");
////				
////				userAgent = "Mozilla/5.0 (iPhone "+mobileVersion.get(OtherClass.randomNum(mobileVersion.size()))+"; CPU iPhone OS "+versionNum1+" like Mac OS X) AppleWebKit/"+versionNum2+" (KHTML, like Gecko) Version/"+versionNum1+" MQQBrowser/"+versionNum3+" Mobile/"+versionNum4+" Safari/"+versionNum5+" Language/zh_CN";
////				
//		//}
//		
//		return userAgent;
//	}
	...
	public static String randMUserAgentString(int num) {
		...
		if(OtherClass.getRandomBetweenNumbers(0, 10)%2 == 0) {
