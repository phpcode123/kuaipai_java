...
public class Settings {
	...
	//程序主要名称
	public static String mainName = "baidu_m";
    ...
    //当在页面中查找到了元素后是否执行点击，需要改善站长平台后台数据中的展现量和点击率的比例关系，改善点击率100%的问题
    //程序逻辑：随机取数组中的值，如果值是1就执行点击，值是0就不点击。当不点击时，页面就会自动的刷新一次。
    public static int[] clickUrlNumArray = new int[]{1,1,0};
	...
	public static String baseWindowsPath = "C:\\kuaipai"+File.separator+mainName+File.separator;
	...
	public static List<String> domainList(){
		List<String> domainList = OtherClass.readLines(Settings.BasePath()+"m_domain.txt");
		return domainList;
	}
	
	//读取pc的点击关键词
	public static ArrayList<String> clickKeywordList(){
		HashSet<String> keywordList = OtherClass.readLinesToHashSet(Settings.BasePath()+"m_keyword.txt");
	...
	//chromedriver path
	public static String winChromeDriver = "C:\\kuaipai\\chromedriver_win32\\chromedriver.exe";
