...
//		userAgentList.add("Mozilla/5.0 (iPhone; CPU iPhone OS 10_1_1 like Mac OS X) AppleWebKit/602.2.14 (KHTML, like Gecko) Version/10.0 MQQBrowser/8.8.2 Mobile/14B100 Safari/602.11");
		...
		userAgentList.add("Mozilla/5.0 (X11; OpenBSD i386) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.125 Safari/537.36");
		...
		userAgentList.add("Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.137 Safari/4E423F");
		...
		userAgentList.add("Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.517 Safari/537.36");
		...
		userAgentList.add("Mozilla/5.0 (X11; CrOS i686 4319.74.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1547.57 Safari/537.36");
		...
		userAgentList.add("Mozilla/5.0 (X11; NetBSD) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.116 Safari/537.36");
		...
		userAgentList.add("Opera/9.80 (Windows NT 6.1; U; zh-cn) Presto/2.9.181 Version/12.00");
		userAgentList.add("Opera/12.0(Windows NT 5.1;U;zh-cn)Presto/22.9.168 Version/12.00");
		userAgentList.add("Mozilla/5.0 (Windows NT 5.1) Gecko/20100101 Firefox/14.0 Opera/12.0");
		userAgentList.add("Opera/9.80 (Windows NT 6.1; WOW64; U; zh-cn) Presto/2.10.229 Version/11.62");
		userAgentList.add("Opera/9.80 (Windows NT 6.0; U; zh-cn) Presto/2.10.229 Version/11.62");
		userAgentList.add("Opera/9.80 (Macintosh; Intel Mac OS X 10.6.8; U; zh-cn) Presto/2.9.168 Version/11.52");
		userAgentList.add("Opera/9.80 (Macintosh; Intel Mac OS X 10.6.8; U; zh-cn) Presto/2.9.168 Version/11.52");
		userAgentList.add("Opera/9.80 (Windows NT 5.1; U; zh-cn) Presto/2.9.168 Version/11.51");
		userAgentList.add("Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; zh-cn) Opera 11.51");
		userAgentList.add("Opera/9.80 (X11; Linux i686; U; zh-cn) Presto/2.8.131 Version/11.11");
		userAgentList.add("Mozilla/5.0 (Windows NT 5.1; U; zh-cn; rv:1.8.1) Gecko/20061208 Firefox/5.0 Opera 11.11");
		userAgentList.add("Opera/9.80 (X11; Linux x86_64; U; zh-cn) Presto/2.8.131 Version/11.10");
		userAgentList.add("Opera/9.80 (Windows NT 6.0; U; zh-cn) Presto/2.8.99 Version/11.10");
		userAgentList.add("Opera/9.80 (Windows NT 5.1; U; zh-cn) Presto/2.8.131 Version/11.10");
		userAgentList.add("Opera/9.80 (Windows NT 6.1; Opera Tablet/15165; U; en) Presto/2.8.149 Version/11.1");
		userAgentList.add("Opera/9.80 (X11; Linux x86_64; U; Ubuntu/10.10 (maverick); pl) Presto/2.7.62 Version/11.01");
		userAgentList.add("Opera/9.80 (Windows NT 6.1; U; zh-cn) Presto/2.7.62 Version/11.01");
		userAgentList.add("Opera/9.80 (Windows NT 5.1; U;) Presto/2.7.62 Version/11.01");
		userAgentList.add("Opera/9.80 (Windows NT 5.1; U; zh-cn) Presto/2.7.62 Version/11.01");
		...
		userAgentList.add("Opera/9.80 (X11; Linux x86_64; U; zh-cn) Presto/2.7.62 Version/11.00");
		userAgentList.add("Opera/9.80 (X11; Linux i686; U; zh-cn) Presto/2.7.62 Version/11.00");
		userAgentList.add("Opera/9.80 (Windows NT 6.1; U; zh-cn) Presto/2.6.37 Version/11.00");
		userAgentList.add("Opera/9.80 (Windows NT 6.1; U; zh-cn) Presto/2.7.62 Version/11.00");
		userAgentList.add("Opera/9.80 (Windows NT 6.1 x64; U; zh-cn) Presto/2.7.62 Version/11.00");
		userAgentList.add("Opera/9.80 (Windows NT 6.0; U; en) Presto/2.7.39 Version/11.00");
		...
		userAgentList.add("Mozilla/5.0 (X11; OpenBSD amd64; rv:28.0) Gecko/20100101 Firefox/28.0");
		userAgentList.add("Mozilla/5.0 (X11; Linux x86_64; rv:28.0) Gecko/20100101 Firefox/28.0");
		...
		userAgentList.add("Mozilla/5.0 (Microsoft Windows NT 6.2.9200.0); rv:22.0) Gecko/20130405 Firefox/22.0");
		userAgentList.add("Mozilla/5.0 (Windows NT 6.2; Win64; x64; rv:16.0.1) Gecko/20121011 Firefox/21.0.1");
		userAgentList.add("Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:21.0) Gecko/20130331 Firefox/21.0");
		userAgentList.add("Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:21.0) Gecko/20100101 Firefox/21.0");
		userAgentList.add("Mozilla/5.0 (X11; Linux i686; rv:21.0) Gecko/20100101 Firefox/21.0");
		...
		userAgentList.add("Mozilla/1.22 (compatible; MSIE 10.0; Windows 3.1)");
		userAgentList.add("Mozilla/5.0 (Windows; U; MSIE 9.0; WIndows NT 9.0; zh-cn))");
		...
		userAgentList.add("Mozilla/5.0 (Android 2.2; Windows; U; Windows NT 6.1; zh-cn) AppleWebKit/533.19.4 (KHTML, like Gecko) Version/5.0.3 Safari/533.19.4");
		...
		int userAgentRandomNum = RandUserAgent.randomNum(userAgentList.size());
